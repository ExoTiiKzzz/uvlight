...
<?php
  ...
  <form action="trait.php" method="post">
                                ...
                                <input class="villeinput form-control" list="suggestionList" id="answerInput" placeholder="Ville">
                                    <datalist id="suggestionList">
                                        <?php foreach ($cities as $key) {?>
                                            <option data-value="<?php echo $key["c_ID"] ?>"><?php echo "<div style='display: none'>".$key["c_ID"]."</div><b> ".$key["zip_code"]." </b> ".$key["c_name"] ?></option>
                                        <?php
                                        } ?>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form action="trait.php" method="post">
                                ...
                                <div class="row form-group">
                                    <div class="col">
                                        <input class="villeinputupdate form-control" list="suggestionList" id="villeinputupdate" placeholder="Ville" autocomplete="off" value="<?php echo $key["fk_com_ID"]." ".$key["zip_code"]." ".$key["c_name"] ?>">
                                            <datalist id="suggestionList">
                                                <?php foreach ($cities as $subkey) {?>
                                                    <option data-value="<?php echo $subkey["c_ID"] ?>"><?php echo $subkey["c_ID"]." ".$subkey["zip_code"]." ".$subkey["c_name"] ?></option>
                                                <?php
                                                } ?>
                                                
                                            </datalist>
                                        <input type="hidden" name="ville" id="villeinputupdate-hidden" required value="<?php echo $key["fk_com_ID"] ?>">
                                    </div>
                                    <div class="col">
    ...
    <script> //initialisation datatable
        ...
        //datalist cities
        document.querySelector('.villeinput[list]').addEventListener('input', function(e) {
            var input = e.target,
        ...
        document.querySelector('.villeinputupdate[list]').addEventListener('input', function(e) {
            var input = e.target,
                list = input.getAttribute('list'),
                options = document.querySelectorAll('#' + list + ' option'),
                hiddenInput = document.getElementById(input.getAttribute('id') + '-hidden'),
