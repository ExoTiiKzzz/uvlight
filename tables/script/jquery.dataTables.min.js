...
(function(h) {
    ...
    function Ca(a) {
        ...
        if (a) {
            ...
            !a.sEmptyTable && (d && "Pas d'enregistrements disponibles" === b.sEmptyTable) && F(a, a, "sZeroRecords", "sEmptyTable");
    ...
    function qb(a) {
        var b = a.oClasses
          ...
          , e = a.oPreviousSearch
          , f = a.aanFeatures
          , g = '<input type="search" class="searchInput ' + b.sFilterInput + '"/>'
          , j = d.sSearch
    ...
    n.defaults = {
        ...
        oLanguage: {
            ...
            sEmptyTable: "Pas de données disponibles",
            sInfo: "Affichage des entrées de _START_ à _END_ sur _TOTAL_ entrées totales",
            sInfoEmpty: "Aucune donnée.",
            sInfoFiltered: "(Filtré parmis les _MAX_ entrées totales)",
            sInfoPostFix: "",
            sDecimal: "",
            sThousands: ",",
