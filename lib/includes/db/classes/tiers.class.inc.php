...
class Tiers{
    ...
    public function db_get_all(){
        ...
        $request = "SELECT * FROM ".DB_TABLE_TIERS." 
                    ...
                    INNER JOIN ".DB_TABLE_TYPE_SOCIETE." ON ".DB_TABLE_TIERS.".fk_typso_ID = ".DB_TABLE_TYPE_SOCIETE.".typso_ID";
    ...
    public function db_soft_delete_multi($id_array){
        ...
        $request = "UPDATE ".DB_TABLE_TIERS." SET tie_is_visible = 0 WHERE tie_ID IN (:list_id)";
        $sql = $conn->prepare($request);
